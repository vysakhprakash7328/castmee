...
urlpatterns = [
    ...
    path(
        "update_artist/",
        ArtistExtendedUpdateAPIView.as_view(),
        name="ArtistExtendedUpdateAPIView",
    ),
    path(
        "get_artist_user/",
        ArtistExtendedUpdateAPIView.as_view(),
    ...
    path(
        "update_producer/",
        ProducerExtendedAPIView.as_view(),
        name="ProducerExtendedAPIView",
    ),
    path(
        "get_producer_user/",
        ProducerExtendedAPIView.as_view(),
    ...
    path(
        "get_related_wishlist/",
        WishlistSaver.as_view(),
        name="get related wishlist for a producer",
    ),
    path(
        "get_producer_request/",
        RequestContactApprover.as_view(),
        name="get_artist_related_wishlist",
    ),
    path(
        "approve_producer_request/",
        RequestContactApprover.as_view(),
        name="approve producer request",
    ),
    ...
    path(
        "view_requested_contacts/", RequestContactSave.as_view(), name="request_contact"
    ),
